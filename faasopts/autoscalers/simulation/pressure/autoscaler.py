...
class SimPressureAutoscaler(PressureAutoscaler):
    ...
    def __init__(self,  ctx: PlatformContext, parameters: PressureAutoscalerParameters,
                 ...
                 metrics: Metrics, result_q, faas: FaasSystem, env, pressure_service: PressureService):
        super().__init__(ctx, parameters, zone, replica_factory, now, metrics, pressure_service)
